...
class StripeController extends Controller
{
    ...
    private function onPaymentSucceeded($paymentIntent): void
    {
        ...
        try {
            ...
            Log::error('settled customer email failed for order ' . $order->id . ': ' . $e->getMessage());
        }
        ...
        try {
            ...
            Log::error('Payment settled admin email failed for order ' . $order->id . ': ' . $e->getMessage());
        }

        Log::info('payment settled for order ' . $order->id);
    }
    ...
    private function onPaymentFailed($paymentIntent): void
    {
        ...
        try {
            ...
            Log::error('Payment failed customer email failed for order ' . $order->id . ': ' . $e->getMessage());
        }
        ...
        try {
            ...
            Log::error('Payment failed admin email failed for order ' . $order->id . ': ' . $e->getMessage());
        }
