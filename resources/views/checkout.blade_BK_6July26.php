...
@section('content')
    ...
    <x-page-header title="Checkout" :breadcrumbs="[
            ['label' => 'Home', 'url' => '/'],
                                            ...
                                            <p class="form-row form-row-wide validate-required">
                                                ...
                                                <span class="input-wrapper">
                                                    <select id="billing_country" name="billing_country"
                                                        ...
                                                        data-selected-country="{{ $billingCountry }}"
                                                        data-selected-state="{{ $billingState }}"></select>
                                                </span>
                                            </p>
                                            <p class="form-row address-field validate-required form-row-wide">
                                                ...
                                                <span class="input-wrapper">
                                                    <input type="text" class="input-text" name="billing_address_1"
                                                        ...
                                                        value="{{ $billingAddress1 }}" autocomplete="address-line1">
                                                </span>
                                            </p>
                                            <p class="form-row address-field form-row-wide">
                                                ...
                                                <span class="input-wrapper">
                                                    <input type="text" class="input-text" name="billing_address_2"
                                                        ...
                                                        value="{{ $billingAddress2 }}" autocomplete="address-line2">
                                                </span>
                                            </p>
                                            <p class="form-row address-field validate-required form-row-wide">
                                                <label for="billing_city" class="">Town / City <span class="required"
                                                        title="required">*</span></label>
                                                <span class="input-wrapper">
                                                    <input type="text" class="input-text" name="billing_city"
                                                        value="{{ $billingCity }}" autocomplete="address-level2">
                                                </span>
                                            </p>
                                            <p
                                                ...
                                                <span class="input-wrapper">
                                                    <select id="billing_state" name="billing_state"
                                                        data-selected-state="{{ $billingState }}"
                                                        class="state-select custom-select"></select>
                                                </span>
                                            </p>
                                            <p
                                                ...
                                                <span class="input-wrapper">
                                                    <input type="text" class="input-text" name="billing_postcode"
                                                        value="{{ $billingPostcode }}" autocomplete="postal-code">
                                                </span>
                                            </p>
                                            <p class="form-row form-row-wide validate-required validate-phone">
                                                ...
                                                <span class="input-wrapper">
                                                    <input type="tel" class="input-text" name="billing_phone"
                                                        value="{{ $billingPhone }}" autocomplete="tel">
                                                </span>
                                            </p>
                                            <p class="form-row form-row-wide validate-required validate-email">
                                                ...
                                                <span class="input-wrapper">
                                                    <input type="email" class="input-text" name="billing_email"
                                                        value="{{ $billingEmail }}" autocomplete="email">
                                                </span>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="shipping-fields">
                                    ...
                                    @if($canShipDifferent)
                                        ...
                                        <p class="form-row form-row-wide ship-to-different-address">
                                            <label class="checkbox">
                                                <input class="input-checkbox" type="checkbox" name="ship_to_different_address"
                                        ...
                                        <div class="shipping-address" id="shipping-address-fields" style="display:none;">
                                            ...
                                            <p class="form-row form-row-wide address-field">
                                                <label for="shipping_country" class="">Country / Region <span class="required"
                                                        title="required">*</span></label>
                                                <span class="input-wrapper">
                                                    <select id="shipping_country" name="shipping_country"
                                                        class="country-select custom-select"></select>
                                                </span>
                                            </p>
                                            <p class="form-row address-field form-row-wide">
                                            ...
                                            <p class="form-row address-field validate-state form-row-wide">
                                                <label for="shipping_state" class="">State / County <span class="required"
                                                        title="required">*</span></label>
                                                <span class="input-wrapper">
                                    ...
                                    @else
                                        ...
                                        <p class="form-row form-row-wide" style="margin-top: 0.5rem;">
                                            <small class="text-muted" style="font-size: 14px;">
                                                ...
                                                If you need to ship to a different address, please <a href="/contact">contact
                                                    us</a>.
                                            </small>
                                        </p>
                                    @endif
                                        ...
                                        <div class="coupon-code">
                                            ...
                                            <div class="coupon" id="coupon-input-group">
                                                <input type="text" name="coupon_code" class="input-text"
                                                    id="checkout-coupon-code" value="" placeholder="Coupon code">
                                                <button type="button" name="apply_coupon" id="apply-coupon-btn"
                                                    class="coupon-button" value="Apply coupon">Apply coupon</button>
                                            </div>
                                            <div id="coupon-applied-group" style="display:none;">
                                                ...
                                                <button type="button" id="remove-coupon-btn"
                                                    class="btn btn-link text-danger p-0 ms-2">Remove</button>
                                            </div>
                                    ...
                                    <div id="payment" class="checkout-payment">
                                        <ul class="payment-methods methods custom-radio">
                                            <li class="payment-method">
                                                <input type="radio" class="input-radio" name="payment_method" value="ach"
                                                    id="payment_method_ach" checked>
                                                <label for="payment_method_ach">ACH </label>
                                                <div id="stripe-ach-container"
                                                    style="display:none; padding: 15px; background: #f8f9fa; border: 1px solid #e9ecef; border-radius: 4px; margin-top: 10px; margin-bottom: 10px;">
                                                    <p style="margin-bottom: 12px; font-size: 14px; color: #555;">Securely
                                                        link your bank account to authorize payment.</p>
                                                    <button type="button" id="stripe-link-btn" class="button alt"
                                                        style="background: #111; color: #fff; padding: 8px 16px; font-weight: 600; border-radius: 4px; border: none; font-size: 14px; text-transform: uppercase;">
                                                        <i class="fa fa-university" style="margin-right: 8px;"></i> Link
                                                        Bank Account
                                                    </button>
                                                    <div id="stripe-linked-info"
                                                        style="display:none; margin-top: 12px; color: #28a745; font-weight: 600; font-size: 14px;">
                                                        <i class="fa fa-check-circle" style="margin-right: 4px;"></i>
                                                        Linked: <span id="stripe-bank-name"></span> (••••<span
                                                            id="stripe-account-mask"></span>)
                                                    </div>
                                                    <div id="stripe-error"
                                                        style="display:none; margin-top: 10px; color: #dc3545; font-size: 14px;">
                                                    </div>
                                                    <input type="hidden" name="stripe_payment_method_id"
                                                        id="stripe_payment_method_id">
                                                    <input type="hidden" name="stripe_bank_name"
                                                        id="stripe_bank_name_input">
                                                    <input type="hidden" name="stripe_account_mask"
                                                        id="stripe_account_mask_input">
                                                    <input type="hidden" name="stripe_customer_id"
                                                        id="stripe_customer_id_input">
                                                </div>
                                            </li>
                                            <li class="payment-method">
                                                <input type="radio" class="input-radio" name="payment_method" value="echeck"
                                                    id="payment_method_echeck">
                                                <label for="payment_method_echeck">Echeck </label>
                                            </li>
                                            <li class="payment-method">
                                                <input type="radio" class="input-radio" name="payment_method"
                                                    value="credit_card" id="payment_method_credit_card">
                                                <label for="payment_method_credit_card">Credit card </label>
                                            </li>
                                            <li class="payment-method">
                                                <input type="radio" class="input-radio" name="payment_method"
                                                    value="bank_wire" id="payment_method_bank_wire">
                                                <label for="payment_method_bank_wire">Bank Wire </label>
                                            </li>
                                            <li class="payment-method">
                                                <input type="radio" class="input-radio" name="payment_method" value="zelle"
                                                    id="payment_method_zelle">
                                        ...
                                        <div class="form-row place-order">
                                            <div class="terms-and-conditions-wrapper mb-3">
                                                <p class="form-row form-row-wide">
                                                    <label class="checkbox">
                                                        <input type="checkbox" class="input-checkbox" name="agree_terms"
                                                            id="agree_terms" value="1">
                                                        <span>I agree to the <a href="{{ route('sales-policy') }}"
                                                                target="_blank" rel="noopener">Sales Policy</a>, <a
                                                                href="{{ route('returns-exchanges-policy') }}"
                                                                target="_blank" rel="noopener">Returns & Exchanges
                                                                Policy</a>, <a href="{{ route('terms-of-sale') }}"
                                                                target="_blank" rel="noopener">Terms of Sale</a>, and <a
                                                                href="{{ route('anti-money-laundering-policy') }}"
                                                                target="_blank" rel="noopener">Anti Money Laundering
                                                                Policy</a> <span class="required"
                                                                title="required">*</span></span>
                                                    </label>
                                                </p>
                                                <p id="agree-terms-error" class="text-danger"
                                                    style="display:none; margin-top: 4px;">You must agree to the Sales
                                                    Policy, Returns & Exchanges Policy, Terms of Sale, and Anti Money
                                                    Laundering Policy to complete your order.</p>
                                            </div>
                                            ...
                                            <button type="submit" name="checkout_place_order" id="place-order-btn"
                                                class="button alt">Confirm Order</button>
                                            <div id="checkout-loading" style="display:none;margin-top:10px;"><span
...
@push('scripts')
    ...
    @if(env('PAYPAL_SANDBOX'))
        <script
            src="https://www.paypal.com/sdk/js?client-id={{ env('PAYPAL_SANDBOX_CLIENT_ID') }}&disable-funding=credit,card,paylater"></script>
    @else
        <script
            src="https://www.paypal.com/sdk/js?client-id={{ env('PAYPAL_LIVE_CLIENT_ID') }}&disable-funding=credit,card,paylater"></script>
    @endif
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            // Custom styling for Stripe Elements to match Bootstrap's input fields
            var style = {
                base: {
                    color: '#495057',
    ...
    <script>
        $(document).ready(function () {
            ...
            function toggleStripeFields() {
                var selected = $('input[name="payment_method"]:checked').val();
                if (selected === 'ach' || selected === 'echeck') {
                    var targetLi = $('#payment_method_' + selected).closest('li');
                    $('#stripe-ach-container').appendTo(targetLi).show();
                } else {
                    $('#stripe-ach-container').hide();
                }
            }
            ...
            function initExpressWallet(walletKey, containerSel, errorsSel) {
                ...
                ece.on('ready', function (event) {
                    ...
                    // If the wallet isn't available on this device/browser, tell the user.
                    if (!event || !event.availablePaymentMethods) {
                        $(errorsSel).text('This payment option is not available on this device or browser.').show();
                    }
                });

                ece.on('loaderror', function () {
                    hidePaymentLoader(containerSel);
                    $(errorsSel).text('Unable to load this payment option. Please refresh and try again, or choose another method.').show();
                });
                    ...
                    if (!paymentMethodId) {
                        ...
                        stripe.createPaymentMethod({
                            ...
                            billing_details: {
                                ...
                                address: {
                                    line1: $('input[name="billing_address_1"]').val() || undefined,
                                    line2: $('input[name="billing_address_2"]').val() || undefined,
                                    city: $('input[name="billing_city"]').val() || undefined,
                                    state: $('#billing_state').val() || undefined,
                                    postal_code: $('input[name="billing_postcode"]').val() || undefined,
                            ...
                            if (result.error) {
                                ...
                                $('#checkout-errors').html('<div class="alert alert-danger text-danger">' + result.error.message + '</div>').show();
                            } else {
    ...
    <script>
        $(document).ready(function () {
            function toggleManualPaymentMessage() {
                var selected = $('input[name="payment_method"]:checked').val();
                var manualMethods = ['zelle', 'cheque'];
