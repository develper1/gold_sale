            ...
            <form action="{{ route('admin.shipping.update', $shipping) }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" step="0.01" name="order_amount" class="form-control" value="{{ $shipping->order_amount }}" required>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label>Shipping Charges</label>
                        <input type="number" step="0.01" name="shipping_charges" class="form-control" value="{{ $shipping->shipping_charges }}" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
